...
function Bitcoin() {
    ...
    useEffect(() => {
        const ws = new WebSocket('wss://stream.binance.com:9443/ws/filusdt@trade');
    ...
    return (
        <div>
            <div className="flex mr-8 h-[25vh] overflow-hidden border border-2-white rounded-lg p-2 justify-center items-center shadow-md" style={{ scrollSnapAlign: 'start' }}>
                <div className='flex flex-col'>
                    <div className="text-green-500">Filcoin</div>
                ...
                {res.length > 0 ? (<Box sx={{ width: '16vw', height: "10vh", display: "flex", justifyContent: "center", alignItems: "center" }}>
