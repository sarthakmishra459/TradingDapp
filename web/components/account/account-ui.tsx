...
export function AccountBalance({ address }: { address: PublicKey }) {
  ...
  return (
    <div>
      <h1
        className="text-5xl font-bold cursor-pointer  text-white"
    ...
    <div>
      ...
      <div className="space-x-2 text-white">
        <button
          ...
          className="btn btn-xs lg:btn-md btn-outline text-white"
    ...
    <div className="space-y-2">
      <div className="justify-between">
        <div className="flex justify-between">
          <h2 className="text-2xl font-bold text-white">Token Accounts</h2>
      ...
      {query.isSuccess && (
        <div>
          {query.data.length === 0 ? (
            ...
            <table className="table border-4 rounded-lg text-white border-separate border-base-300">
              <thead>
